...
class QRCodeGenerator {
  ...
  async generateQRCode() {
    ...
    try {
      // 清空输出区域
      if (this.qrOutput) {
        this.qrOutput.innerHTML = `<div class="qr-loading">${t('qr.generating')}</div>`;
      }
